...
\par\noindent {\scriptsize ({\bf Gráfico 1}: Pontos experimentais referentes aos valores da corrente como função da tensão entre os terminais da célula fotovoltaica.)
\end{center}
...
\par\noindent {\scriptsize ({\bf Gráfico 2}: Pontos experimentais referentes aos valores da potência em função da corrente.)}
\end{center}
...
60 & 1.203$\pm$0.001 & (1.95$\pm$0.05)$\times10^2$ \tabularnewline
\end{tabular}
\par\noindent {\scriptsize ({\bf Tabela 1}: Valores da potência máxima para cada ângulo e respetiva resistência de carga ótima)}
\end{center}
...
\hline \hline
0  & 100.0 & 1.850$\pm$? \tabularnewline
20 & 94.0  & 1.660$\pm$? \tabularnewline
40 & 76.6  & 1.280$\pm$? \tabularnewline
60 & 50.0  & 0.677$\pm$? \tabularnewline
\end{tabular}
...
\par\noindent {\scriptsize ({\bf Gráfico 3}: Valores da corrente representados em função do nível de iluminação, para uma tensão de $1.7V$)}
\end{center}
...
\par\noindent {\scriptsize ({\bf Gráfico 4}: Valores da tensão representados em função do nível de iluminação, para uma corrente nula)}
\end{center}
...
\hline \hline
0  & 100.0 & 2.994$\pm$? \tabularnewline
20 & 94.0  & 2.759$\pm$? \tabularnewline
40 & 76.6  & 2.184$\pm$? \tabularnewline
60 & 50.0  & 1.053$\pm$? \tabularnewline
\end{tabular}
...
\par\noindent {\scriptsize ({\bf Gráfico 5}: Valores da potência representados em função do nível de iluminação, para uma resistência de $1250\Omega$)}
\end{center}
...
\par\noindent {\scriptsize ({\bf Gráfico 6}: Valores da resistência de carga ótima representados em função do nível de iluminação)}
\end{center}
...
\par\noindent {\scriptsize ({\bf Gráfico 7}: Valores da potêcia máxima representados em função do nível de iluminação)}
\end{center}
...
\begin{center}
%\includegraphics[width=240pt]{Pmax}
\par\noindent {\scriptsize ({\bf Gráfico 8}: Representação de $\log{P}$ como função de $\log{d}$)}
\end{center}
...
\par Assim, para o primeiro regime não se considera uma lei de potência enquanto que no tocante ao segundo regime se considera uma lei cuja forma será dada pela expressão \frac{e^ {-4.29}}{d^{2.78}}
